    ...
    return (
        ...
        <div className="flex gap-4 w-full pl-10">
         ...
         <img className="w-[560px] h-[315px]" src="public/b23.jpg"/>
            ...
            <h1 className="text-center font-extrabold text-rose-950 m-10 text-4xl">বিক্রি হবে ১২ টি ষাঁড়</h1>
...
<div class="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    ...
    <div class="px-4 py-2">
        <h1 class="text-xl font-bold text-gray-800 uppercase dark:text-white">ফ্রিজিয়ান জাতের</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">দাম আলোচনা সাপেক্ষে</p>
    </div>

   <img src="public/b23.jpg"/>
